...
#make.spectra.df<-function(spectra.list, sample) {
  #paste0"sample"<<-as.data.frame(spectra.list$('sample'))
  #return("spectra object in global environment")
#}
...
format.spectra.df<-function(data.frame, sample, ribotype){
  ...
  write.table(data.frame,file=(paste0(sample, ".txt")))
}
