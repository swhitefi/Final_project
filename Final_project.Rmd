...
plot.spectra offers a pre-formatted m/z by relative intensity plot. It is usefull to be able to see your data quickly.
```{r}
...
lines(F200_2.1$rel.intensity~F200_2.1$m.z, type="l", col="dark green")
lines(F200_2.2$rel.intensity~F200_2.2$m.z, type="l", col="dark green")
lines(F200_3.1$rel.intensity~F200_3.1$m.z, type="l", col="light green")
lines(F200_3.2$rel.intensity~F200_3.2$m.z, type="l", col="light green")
