...
s2398_1.2<-read.table(file="2398_1-1.txt", header=T)
s2398_3.1<-read.table(file="2398_1-1.txt", header=T)
...
s2398_1.2$rel.intensity<-s2398_1.1$intensity/max(s2398_1.2$intensity)
s2398_3.1$rel.intensity<-s2398_1.1$intensity/max(s2398_3.1$intensity)
```
